// src/lib.rs
/*
 * Core library for TeachingMelody
 */
...
#[derive(Debug)]
pub struct TeachingMelodyProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TeachingMelodyProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TeachingMelody processing");
    
    let mut processor = TeachingMelodyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TeachingMelodyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TeachingMelodyProcessor::new(false);
